/* This file is used to show the page containing complete detail of the selected festival.
*/

tourism.views.FestivalDetail = Ext.extend(Ext.Panel, {
    ...
    initComponent: function(){
        ...
        this.dockedItems = [{
			...
			items: [{
                ...
                handler: function(){
                    this.ownerCt.setActiveItem(new tourism.views.FestivalList({
						prevToprev:this.prevToprev, filterBy:this.filterBy, byCategory:this.byCategory,
					}));
					this.destroy();
                }
            },{
        ...
        this.items = [{
            tpl: new Ext.XTemplate( '<h3>{name} </h3><h4 class="subdata">{name} {dates}</h4> {description}'),
            data: this.record.data,
            styleHtmlContent: true
        }];
        
        tourism.views.FestivalDetail.superclass.initComponent.call(this);
    }
});

Ext.reg('FestivalDetail', tourism.views.FestivalDetail);